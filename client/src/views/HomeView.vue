<template>
  <div class="h-screen w-screen flex items-center justify-center">
    <AuroraBackground class="w-screen">
      <main id="main" class="inset-0 flex flex-col h-5/6 justify-center items-center gap-20 p-10 z-10">
    ...
    <Loader v-if="displayLoader"
            class="absolute w-full inset-0 flex flex-col justify-center items-center gap-20 p-10 z-10"
